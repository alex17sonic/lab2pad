...
public class TransportListener {
    ...
    public TransportListener(int dataServerPort) throws IOException {
        mavenLocation = new InetSocketAddress("127.0.0.1", 5555);
        switch (dataServerPort) {
            case 1111:
                sendDataUdp(mavenLocation, new Employee("Victor", "Rotaru", "Vinzari", 501.0));
                System.out.println("[INFO] -----------------------------------------\n" +
                        "[INFO] Data was sent to Maven");
                break;
            case 2222:
                sendDataUdp(mavenLocation, new Employee("Angela", "Andreev", "Marketing", 502.0));
                System.out.println("[INFO] -----------------------------------------\n" +
                        "[INFO] Data was sent to Maven");
                break;
            case 3333:
                sendDataUdp(mavenLocation, new Employee("Veaceslav", "Sofroni", "Financiar", 503.0));
                System.out.println("[INFO] -----------------------------------------\n" +
                        "[INFO] Data was sent to Maven");

                break;
            case 4444:
                sendDataUdp(mavenLocation,new Employee("Valeriu", "Munteanu", "Tehnic", 504.0));
                System.out.println("[INFO] -----------------------------------------\n" +
                        "[INFO] Data was sent to Maven");
                break;
            ...
            case 5555:
                ...
                break;
            case 6666:
                sendDataUdp(mavenLocation,new Employee("Alexandru", "Pasarescu", "Tehnic", 505.0));
                System.out.println("[INFO] -----------------------------------------\n" +
                        "[INFO] Data was sent to Maven");
                break;
            default:
